...
namespace ECO.DAL.Migrations
{
    ...
    [Migration("20260922122435_AddCategoryParentRelationship")]
    partial class AddCategoryParentRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECO.DAL.Entities.EmailTemplateSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TemplateType", "Language")
                        .HasDatabaseName("IX_EmailTemplateSettings_Type_Lang");

                    b.HasIndex("OwnerEmail", "TemplateType", "Language")
                        .HasDatabaseName("IX_EmailTemplateSettings_Owner_Type_Lang");

                    b.ToTable("EmailTemplateSettings");
                });
            ...
            modelBuilder.Entity("ECO.DAL.Entities.StoreSettings", b =>
                {
                    ...
                    b.Property<string>("EmailDefaultLanguage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ECO.DAL.Entities.Product.Category", b =>
                {
                    b.HasOne("ECO.DAL.Entities.Product.Category", "ParentCategory")
